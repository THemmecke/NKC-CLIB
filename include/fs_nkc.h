...
/*
 ...
 Harddisk:
  ...
  42-43			last track
  44-47			current buffer ptr	current memor transfer address
...
struct jdfcb {
	...
	/* ----- extension fields --------------- */
	/* we do not use struct jdfileinfo without usinng JADOS, instead we add necessary fields here and stay backward compatible ... */
